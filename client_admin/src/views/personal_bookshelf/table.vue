<template>
	<el-main class="bg table_wrap">
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row>
					...
					<el-form-item label="图书类别">
									<el-input v-model="query.book_category"></el-input>
								</el-form-item>
				</el-col>
					...
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/personal_bookshelf/table','add') || $check_action('/personal_bookshelf/view','add')" class="el-button el-button--default el-button--primary search_btn_add" to="./view?">添加
						</router-link>
            			<el-button v-if="user_group == '管理员' || $check_action('/personal_bookshelf/table','del') || $check_action('/personal_bookshelf/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/personal_bookshelf/table','set') || $check_action('/personal_bookshelf/view','set') || $check_action('/personal_bookshelf/view','get') || $check_action('//table','add') || $check_action('//view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/personal_bookshelf/table','set') || $check_action('/personal_bookshelf/view','set') || $check_action('/personal_bookshelf/view','get')"
	...
	export default {
		...
		data() {
			return {
				...
				url_del: "~/api/personal_bookshelf/del?",
