	...
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
				...
				<el-form-item label="图书编号" prop="book_number">
							  ...
							  v-if="user_group === '管理员' || (form['personal_bookshelf_id'] && $check_field('set','book_number')) || (!form['personal_bookshelf_id'] && $check_field('add','book_number'))" :disabled="disabledObj['book_number_isDisabled']"></el-input>
				...
				<el-form-item label="图书名称" prop="book_name">
							  ...
							  v-if="user_group === '管理员' || (form['personal_bookshelf_id'] && $check_field('set','book_name')) || (!form['personal_bookshelf_id'] && $check_field('add','book_name'))" :disabled="disabledObj['book_name_isDisabled']"></el-input>
				...
				<el-form-item label="图书类别" prop="book_category">
							  ...
							  v-if="user_group === '管理员' || (form['personal_bookshelf_id'] && $check_field('set','book_category')) || (!form['personal_bookshelf_id'] && $check_field('add','book_category'))" :disabled="disabledObj['book_category_isDisabled']"></el-input>
				...
				<el-form-item label="作者" prop="author">
							  ...
							  v-if="user_group === '管理员' || (form['personal_bookshelf_id'] && $check_field('set','author')) || (!form['personal_bookshelf_id'] && $check_field('add','author'))" :disabled="disabledObj['author_isDisabled']"></el-input>
				...
				<el-form-item label="出版社" prop="press">
							  ...
							  v-if="user_group === '管理员' || (form['personal_bookshelf_id'] && $check_field('set','press')) || (!form['personal_bookshelf_id'] && $check_field('add','press'))" :disabled="disabledObj['press_isDisabled']"></el-input>
				...
				<el-form-item label="用户编号" prop="user_number">
							...
							<!--v-if="user_group === '管理员' || (form['personal_bookshelf_id'] && $check_field('set','user_number')) || (!form['personal_bookshelf_id'] && $check_field('add','user_number'))" :disabled="disabledObj['user_number_isDisabled']"></el-input>-->
							<!--<div v-else-if="$check_field('get','user_number')">{{form['user_number']}}</div>-->
							<el-select v-if="user_group === '管理员' || (form['personal_bookshelf_id'] && $check_field('set','user_number')) || (!form['personal_bookshelf_id'] && $check_field('add','user_number'))" id="user_number" v-model="form['user_number']" :disabled="disabledObj['user_number_isDisabled']">
				...
				<el-form-item label="电话" prop="telephone">
							  ...
							  v-if="user_group === '管理员' || (form['personal_bookshelf_id'] && $check_field('set','telephone')) || (!form['personal_bookshelf_id'] && $check_field('add','telephone'))" :disabled="disabledObj['telephone_isDisabled']"></el-input>
