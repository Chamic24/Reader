<template>
	<view class="diy_details diy_div_personal_bookshelf">
		<view v-if="Object.keys(obj).length!==0" class="warp">
			<view class="container">
				<view class="row">
					...
					<view v-if="$check_field('get','telephone')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>电话:</span>
						</view>
							<view class="diy_field diy_text">
...
<script>
	...
	export default {
		...
		methods: {
			...
			async get_obj_by_id(){
				var res = await this.$get("~/api/personal_bookshelf/get_obj", {
					personal_bookshelf_id:this.query.personal_bookshelf_id
				})
		...
		async onLoad(){
			...
			} else if (this.query["personal_bookshelf_id"] !==0) {
...
<style scoped>
	.div_personal_bookshelf_details {}
