<template>
  <view class="page_font_style diy_table diy_table_tml" id="font_style_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="字体样式" name="font_style">
                      <uni-easyinput type="text" v-model="query.font_style" placeholder="字体样式" />
                    </uni-forms-item>
                </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/font_style/view?" v-show="user_group == '管理员' || $check_action('/font_style/table','add') || $check_action('/font_style/view','add')">添加</navigator>
		...
		<view class="warp">
			<view class="container">
				<view v-for="(o,i) in list" class="row">
										<view v-if="0 && $check_field('get','font_style')" class="col">
						<view class="view">
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/font_style/table','del') || $check_action('/font_style/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/font_style/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/font_style/table','set') || $check_action('/font_style/view','set') || $check_action('/font_style/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
