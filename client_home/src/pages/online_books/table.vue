<template>
  <view class="page_online_books diy_table diy_table_tml" id="online_books_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/online_books/view?" v-show="user_group == '管理员' || $check_action('/online_books/table','add') || $check_action('/online_books/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','press')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>出版社</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','vip_price')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>VIP价格</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','book_introduction')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>图书简介</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/online_books/table','del') || $check_action('/online_books/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/online_books/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/online_books/table','set') || $check_action('/online_books/view','set') || $check_action('/online_books/view','get')" class="btn btn-primary">详情</navigator>
					                    																		<!--跨表按钮-->
															<a type="button" size="mini" class="btn btn-primary" v-if="$check_action('/personal_bookshelf/view','add')" @click="to_form('/pages/personal_bookshelf/view',o)">
									<span>加入书架</span>
								</a>
															<a type="button" size="mini" class="btn btn-primary" v-if="$check_action('/purchase_vip/view','add')" @click="to_form('/pages/purchase_vip/view',o)">
									<span>购买VIP</span>
								</a>
																						</view>
			</view>
	...
	export default {
		...
		data() {
			return {
				...
				list: [],
                                    // 图书类别列表
                list_book_category: [{value:"",text:"全部"}],
                                                        			}
		},
		methods: {
          search() {
