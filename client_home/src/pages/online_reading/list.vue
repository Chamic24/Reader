<template>
	<view class="page_online_reading diy_list diy_list_page div_list_tml" id="online_reading_list">
		<!-- 筛选模块(开始) -->
		<view>
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator class="btn btn-primary" :url="'./details?online_reading_id=' + o['online_reading_id']">查看详情</navigator>
					</view>
				</view>
			</view>
		</view>
...
<script>
	 ...
	 */
	get_praise(list){
		this.$get("~/api/praise/count_group?groupby=source_id&source_table=online_reading", {}, (res) => {
			if(res.result){
				res.result.map((o)=>{
					for(var i = 0;i < list.length; i++){
						var oj = list[i];
						if(oj["online_reading_id"] === o["source_id"]){
