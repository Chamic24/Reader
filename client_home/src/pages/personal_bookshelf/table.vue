<template>
  <view class="page_personal_bookshelf diy_table diy_table_tml" id="personal_bookshelf_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                    ...
                    <uni-forms-item label="图书类别" name="book_category">
                      <uni-easyinput type="text" v-model="query.book_category" placeholder="图书类别" />
                    </uni-forms-item>
                        </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/personal_bookshelf/view?" v-show="user_group == '管理员' || $check_action('/personal_bookshelf/table','add') || $check_action('/personal_bookshelf/view','add')">添加</navigator>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/personal_bookshelf/table','del') || $check_action('/personal_bookshelf/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/personal_bookshelf/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/personal_bookshelf/table','set') || $check_action('/personal_bookshelf/view','set') || $check_action('/personal_bookshelf/view','get')" class="btn btn-primary">详情</navigator>
					                    									</view>
			</view>
		</view>
	</view>
