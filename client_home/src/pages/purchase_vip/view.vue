          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','book_number') || ($check_field('add','book_number') || $check_field('set','book_number'))" label="图书编号" name="book_number">
                            <uni-easyinput type="text" v-model="form['book_number']" v-if="user_group === '管理员' || (form['purchase_vip_id'] && $check_field('set','book_number')) || (!form['purchase_vip_id'] && $check_field('add','book_number'))" :disabled="disabledObj['book_number_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','book_name') || ($check_field('add','book_name') || $check_field('set','book_name'))" label="图书名称" name="book_name">
                            <uni-easyinput type="text" v-model="form['book_name']" v-if="user_group === '管理员' || (form['purchase_vip_id'] && $check_field('set','book_name')) || (!form['purchase_vip_id'] && $check_field('add','book_name'))" :disabled="disabledObj['book_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','book_category') || ($check_field('add','book_category') || $check_field('set','book_category'))" label="图书类别" name="book_category">
                            <uni-easyinput type="text" v-model="form['book_category']" v-if="user_group === '管理员' || (form['purchase_vip_id'] && $check_field('set','book_category')) || (!form['purchase_vip_id'] && $check_field('add','book_category'))" :disabled="disabledObj['book_category_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','author') || ($check_field('add','author') || $check_field('set','author'))" label="作者" name="author">
                            <uni-easyinput type="text" v-model="form['author']" v-if="user_group === '管理员' || (form['purchase_vip_id'] && $check_field('set','author')) || (!form['purchase_vip_id'] && $check_field('add','author'))" :disabled="disabledObj['author_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','vip_price') || ($check_field('add','vip_price') || $check_field('set','vip_price'))" label="VIP价格" name="vip_price">
                            <uni-easyinput type="text" v-model="form['vip_price']" v-if="user_group === '管理员' || (form['purchase_vip_id'] && $check_field('set','vip_price')) || (!form['purchase_vip_id'] && $check_field('add','vip_price'))" :disabled="disabledObj['vip_price_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','user_number') || ($check_field('add','user_number') || $check_field('set','user_number'))" label="用户编号" name="user_number">
                  ...
                  v-if="user_group === '管理员' || (form['purchase_vip_id'] && $check_field('set','user_number')) || (!form['purchase_vip_id'] && $check_field('add','user_number'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['user_number']"
                  :localdata="list_user_user_number"
              ...
              <uni-forms-item v-if="$check_field('get','full_name') || ($check_field('add','full_name') || $check_field('set','full_name'))" label="姓名" name="full_name">
                            <uni-easyinput type="text" v-model="form['full_name']" v-if="user_group === '管理员' || (form['purchase_vip_id'] && $check_field('set','full_name')) || (!form['purchase_vip_id'] && $check_field('add','full_name'))" :disabled="disabledObj['full_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','telephone') || ($check_field('add','telephone') || $check_field('set','telephone'))" label="电话" name="telephone">
                            <uni-easyinput type="text" v-model="form['telephone']" v-if="user_group === '管理员' || (form['purchase_vip_id'] && $check_field('set','telephone')) || (!form['purchase_vip_id'] && $check_field('add','telephone'))" :disabled="disabledObj['telephone_isDisabled']" />
                <!-- 仅查看 -->
      ...
      uni.chooseFile({
        ...
        success: function(res) {
          ...
          const uploadTask = uni.uploadFile({
            url: _self.$fullUrl('/api/purchase_vip/upload?'),
